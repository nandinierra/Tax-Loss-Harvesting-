...
export const mockHoldings = rawHoldings.map((item, index) => ({
  id: index.toString(),
  assetName: item.coinName,
  assetSymbol: item.coin,
  assetLogo: item.logo,
  amount: item.totalHolding,
  currentPrice: item.currentPrice,
  avgPrice: item.averageBuyPrice,
  stGain: item.stcg.gain,
  ltGain: item.ltcg.gain,
  stBalance: item.stcg.balance,
  ltBalance: item.ltcg.balance,
}));
